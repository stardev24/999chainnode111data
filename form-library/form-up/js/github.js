...
GitHub.prototype.saveFile = function(data) {
   return new Promise(function(resolve, reject) {
      console.log('input data --'+data.repository)
      data.repository.write(
         ...
         function(err) {
            if (err) {
               ...
               var download_url = 'https://raw.githubusercontent.com/stardev24/objectstore/master/'+data.filename
               var tag = '<a href="'+download_url+'">'+data.filename+'</a>'
               document.getElementById("git_form_upload_url").innerHTML = tag;
